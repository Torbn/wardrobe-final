...
function AuthGate({ onLogin }) {
    ...
    const handleLogin = async () => {
        ...
        try {
            ...
            // onAuthStateChanged kommer att plocka upp den nya användaren och App.jsx kommer att renderas om
        } catch (e) {
            setError(e.message);
        } finally {
            setIsLoading(false);
    ...
    const handleCreateNew = async () => {
        ...
        try {
            ...
            // onAuthStateChanged kommer att plocka upp den nya användaren
        } catch (e) {
